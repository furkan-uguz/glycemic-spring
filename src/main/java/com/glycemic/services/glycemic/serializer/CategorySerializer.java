package com.glycemic.services.glycemic.serializer;
...
public class CategorySerializer extends StdSerializer<List<Food>> {
    ...
    @Override
    public void serialize(List<Food> items, JsonGenerator generator, SerializerProvider provider) throws IOException {
